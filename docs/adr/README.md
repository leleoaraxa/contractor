...
> Nota: os ADRs 0014–0019 são mantidos como **Draft** e devem existir como arquivos neste diretório
...
1. **ADR 0014** — Auditoria end-to-end
...
5. **ADR 0015** — Storage e lifecycle de bundles
6. **ADR 0018** — Observabilidade mínima e SLOs
